...
# python ../export_llama/export_qwen2_vl.py \
# 	--model /home/chenl/weights/hf-models/Qwen2-VL-2B-Instruct \
# 	--output /home/chenl/weights/export-models/Qwen2-VL-2B-Instruct/onnx_model/int8_1024/llm/llm.onnx \
# 	--quant /home/chenl/project/ascend/ascend-llm/export_llama/config/w8x8.py

# PACT 1-4
python ../export_llama/export_qwen2_vl.py \
	--model /home/chenl/weights/hf-models/Qwen2-VL-2B-Instruct \
	--output /home/chenl/weights/export-models/Qwen2-VL-2B-Instruct/onnx_model/int8_pact/llm_5_28.onnx \
	--quant /home/chenl/project/ascend/ascend-llm/export_llama/config/w8x8.py